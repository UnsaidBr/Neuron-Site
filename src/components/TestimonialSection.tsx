...
export const TestimonialSection: React.FC = () => {
  return (
    <section className="py-20 relative bg-transparent border-t border-white/5" id="depoimento">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <ScrollReveal direction="up" duration={0.6}>
          ...
          <div className="bg-[#111]/80 backdrop-blur-sm border border-white/10 rounded-2xl p-1 relative overflow-hidden text-left group">
            <div className="relative bg-[#0A0A0A]/90 rounded-xl p-8 sm:p-12 border border-white/5">
