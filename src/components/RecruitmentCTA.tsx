...
export const RecruitmentCTA: React.FC<RecruitmentCTAProps> = ({
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-transparent border-t border-white/5" id="trainee">
            ...
            <div className="relative bg-[#0A0A0A]/90 rounded-xl p-8 sm:p-14 border border-white/5 text-center">
              ...
              <div className="flex justify-center mb-4">
                <div className="relative">
                  ...
                  <NeuronBee size={76} animate={true} />
                </div>
              </div>
              ...
              <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-[#7C3AED]/10 border border-[#7C3AED]/30 text-[10px] font-mono text-[#A78BFA] uppercase tracking-widest font-bold mb-5">
              ...
              <h2 className="text-3xl sm:text-5xl font-bold text-white tracking-tight leading-tight max-w-2xl mx-auto mb-4">
                Quer fazer parte da <span className="text-[#F59E0B]">Colmeia NEURON?</span>
              </h2>

              <p className="text-sm sm:text-base text-white/50 max-w-xl mx-auto mb-8 leading-relaxed font-light">
                Inscrições abertas para novos trainees! Junte-se ao nosso enxame de pesquisadores para transformar o futuro explorando tecnologias que conectam ciência de ponta, robótica e inteligência artificial.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                >
                  <span>INSCREVA-SE NA COLMEIA</span>
