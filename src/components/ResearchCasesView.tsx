  ...
  return (
    <div className="w-full space-y-16">
      ...
      <section className="relative pt-12 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-left">
        ...
        <StaggerContainer staggerDelay={0.08} className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-10">
          <StaggerItem className="h-full">
            <div className="h-full p-4 rounded-xl bg-[#111]/80 backdrop-blur-sm border border-white/10">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <ScrollReveal direction="up" duration={0.6}>
          <div className="bg-[#111]/80 backdrop-blur-sm border border-white/10 rounded-2xl p-1 relative overflow-hidden group">
            <div className="relative bg-[#0A0A0A]/90 rounded-xl p-8 sm:p-12 border border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
