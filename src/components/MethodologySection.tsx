...
export const MethodologySection: React.FC = () => {
  return (
    <section className="w-full py-24 bg-transparent relative overflow-hidden border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        {/* Section Header */}
        <ScrollReveal direction="up" duration={0.6} className="flex flex-col items-center text-center gap-2 max-w-2xl mx-auto">
        ...
        {/* 4 Stages Process Grid with Immersive UI double-layer cards and Stagger animation */}
        <StaggerContainer
          staggerDelay={0.08}
        ...
        >
          {METHODOLOGY_STAGES.map((stage) => (
            ...
            >
              <div
                className="h-full bg-[#111]/80 backdrop-blur-sm border border-white/10 rounded-2xl p-1 relative overflow-hidden group hover:border-white/20 transition-all duration-300 flex flex-col"
              >
