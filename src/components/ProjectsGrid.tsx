  ...
  return (
    <section className="w-full py-20 bg-transparent relative" id="projetos">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {showFilters && (
          <ScrollReveal direction="up" delay={0.1} duration={0.6} className="space-y-4 max-w-5xl mx-auto">
        ...
        {/* Projects Grid with Immersive UI double-layer cards and Stagger animation */}
        <StaggerContainer
          staggerDelay={0.06}
        ...
        >
          {filteredProjects.map((project) => (
            ...
            >
              <article
                className="h-full bg-[#111]/80 backdrop-blur-sm border border-white/10 rounded-2xl p-1 relative overflow-hidden group transition-all duration-300 hover:border-white/20 flex flex-col justify-between"
              >
                ...
                <div className="relative bg-[#0A0A0A]/90 rounded-xl p-5 border border-white/5 flex flex-col justify-between h-full space-y-4">
                  <div>
                    {/* Card Thumbnail with Optimized WebP Image */}
