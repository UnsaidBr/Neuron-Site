...
export const FlagshipProject: React.FC<FlagshipProjectProps> = ({ onSelectProject }) => {
  return (
    <section className="w-full py-20 bg-transparent relative border-b border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-10">
        {/* Flagship Header with Scroll Animation */}
        <ScrollReveal direction="up" duration={0.6} className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
        ...
        <ScrollReveal direction="up" delay={0.15} duration={0.7}>
          <div className="bg-[#111]/80 backdrop-blur-sm border border-white/10 rounded-2xl p-1 relative overflow-hidden group">
            ...
            <div className="relative bg-[#0A0A0A]/90 rounded-xl p-6 md:p-10 border border-white/5 grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-5 flex flex-col justify-between rounded-xl bg-white/5 border border-white/10 p-4 gap-4 relative overflow-hidden group">
                <div className="relative w-full aspect-[4/5] rounded-lg overflow-hidden bg-black/40 border border-white/5">
                  ...
                  <div className="absolute bottom-3 left-3 right-3 p-3 rounded-lg bg-black/85 backdrop-blur-md border border-white/10 flex flex-col gap-2 pointer-events-none">
